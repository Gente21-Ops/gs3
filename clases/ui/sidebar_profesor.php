...
<div id="sidebar">
    <div class="mainNav">
        ...
        <ul class="nav" id="navo"> 
            ...
            <li><a href="#" onclick="assignme('professor_config','content'); return false;" title="" class="linko"><img src="images/icons/mainnav/config.png" alt="" /><span><?php echo $texts['configuracion']; ?></span></a></li>            

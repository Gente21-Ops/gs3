...
<div class="loginWrapper">
	...
	<!-- Current user form -->
    <form action="clases/login_check.php" id="login" method="POST">
        <div class="loginPic">
            <a href="#" title=""><img src="images/userLogin.png" alt="" /></a>
            <span>Bienvenido a GoSchool</span>
        ...
        <div class="logControl">
            <div class="memory"><input type="checkbox" checked="checked" class="check" id="remember1" /><label for="remember1">¿Recordarme?</label></div>
            <input type="submit" name="submit" value="Ingresar" class="buttonM bBlue" />
            <div class="clear"></div>
        </div>
    ...
    <div id="dialog-modal" title="Error">
        <p>Nombre y contraseña incorrectos, por favor vuelva a intentarlo.</p>
    </div>
    <div id="no-session" title="Error">
        <p>No existe la sesión, por favor ingrese nuevamente sus datos.</p>
    </div>

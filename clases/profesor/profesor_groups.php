...
//DICCIONARIO el diccionario de los botones va aquí (since I can't access the dict from here)
    ...
    $elsql = "SELECT 
                ...
                map_materias.idMaterias AS qidmapmaterias 
    ...
    while ($aRow = $sqlt->fetch_assoc()) {
        ...
        $sql2 = "SELECT grupos.idGrupos AS qidgrupo, grupos.nombre AS qnombre, grupos_mapeo_materias.idGrupos_mapeo_materias 
            ...
            AND grupos_mapeo_materias.idMaterias = '".$aRow['qidmapmaterias']."'";
            //echo $sql2."<br>";
            ...
            while ($bRow = $sqlt2->fetch_assoc()) {
                ...
                $chido[] = '<ul class="tbar">
                                <li>
                                    <a href="#" onclick="assignme(\'professor_takelist.php?qcode='.$bRow['qidgrupo'].'\',\'content\'); return false;" title=""><span class="icos-pencil"></span>'.$texts['asistencias'].' '.$bRow['qnombre'].'</a>
                                </li>
                                <li>
                                    <a href="#" onclick="assignme(\'professor_takelist.php?qcode='.$bRow['qidgrupo'].'\',\'content\'); return false;" title=""><span class="icos-copypaste"></span>'.$texts['tareas'].' '.$bRow['qnombre'].'</a>
                                </li>
                                <li>
                                    <a href="#" onclick="assignme(\'professor_takelist.php?qcode='.$bRow['qidgrupo'].'\',\'content\'); return false;" title=""><span class="icos-users"></span>'.$texts['alumnos'].' '.$bRow['qnombre'].'</a>
                                </li>
                                <li>
                                    <a href="#" onclick="assignme(\'professor_takelist.php?qcode='.$bRow['qidgrupo'].'\',\'content\'); return false;" title=""><span class="icos-stats"></span>'.$texts['calif'].' '.$bRow['qnombre'].'</a>
                                </li>
                            </ul>';

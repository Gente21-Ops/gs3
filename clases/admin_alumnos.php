...
include("logon.php");
include('../dict/admin/alumnos.php');

    ob_start();

    //TOP
    $breads = $texts['title'].'^admin_alumnos';
    include('top.php');
?>  
        ...
        <div class="widget">
            ...
            <div id="dyn2" class="shownpars">
                ...
                <tr>
                    ...
                    <th><?php echo $texts['col_direccion']; ?></th>
                    <th><?php echo $texts['col_tel']; ?></th>
                    <th><?php echo $texts['col_email']; ?></th>
                    <th><?php echo $texts['col_fechanac']; ?></th>
                    <th><?php echo $texts['col_factura']; ?></th>
...
<form id="formAddNewRow" action="#" title="<?php echo $texts['agregar']; ?>">
        ...
        <input type="hidden" name="idUsers" id="idGrupos" rel="0" />

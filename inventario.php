...
include('dict/main.php');
    ...
    //require_once('clases/general/inventario.php');
?>
...
<!-- DBINTERACTION -->
<script type="text/javascript" src="js/general/dbinteraction.js"></script>
<!-- DBINTERACTION -->
        ...
        <div class="widget">
            ...
            <div class="shownpars">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="dTable2">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="6" class="dataTables_empty">Cargando la información</td>.
                            </tr>
                        </tbody>
                    </table> 

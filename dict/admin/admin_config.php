...
if($_SESSION['qlen'] == "es"){
	...
	"tabletitle" => "Datos de cuenta del administrador: ",
	...
	"img_but_browse" => "Cambiar foto del administrador",
	"img_advice" => "Haz click en 'Buscar foto'");
} else if($_SESSION['qlen'] == "en"){
	$texts = array(
	"title" => "Account settings", 
	"tabletitle" => "Account data for admin: ",
	...
	"img_but_browse" => "Browse picture for admin ",

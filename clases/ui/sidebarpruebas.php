...
<div id="sidebar">
    <div class="mainNav">
        <div class="user">
            <a title="" class="leftUserDrop"><img src="images/users/72/nino.jpg" alt="" /><span><strong>3</strong></span></a><span>Juan López</span>
            <ul class="leftUser">
        ...
        <!-- Main nav -->
        <ul class="nav">
            <li><a href="index.html" title="" class="active"><img src="images/icons/mainnav/dashboard.png" alt="" /><span>Principal</span></a></li>
            <li><a href="ui.html" title=""><img src="images/icons/mainnav/ui.png" alt="" /><span>Grupos</span></a>
                <ul>
            ...
            <li><a href="forms.html" title=""><img src="images/icons/mainnav/forms.png" alt="" /><span>Tareas</span></a>
                <ul>
            ...
            <li><a href="messages.html" title=""><img src="images/icons/mainnav/messages.png" alt="" /><span>Mensajes</span></a></li>
            <li><a href="statistics.html" title=""><img src="images/icons/mainnav/statistics.png" alt="" /><span>Calificaciones</span></a></li>
            <li><a href="tables.html" title=""><img src="images/icons/mainnav/tables.png" alt="" /><span>Materias</span></a>
                <ul>
            ...
            <li><a href="other_calendar.html" title=""><img src="images/icons/mainnav/other.png" alt="" /><span>Más</span></a>
                <ul>
    ...
    <div class="secNav">
        <div class="secWrapper">
            <div class="secTop">
                <div class="balance">
                    <div class="balInfo">Promedio:<span>21 de Octubre de 2013</span></div>
                    <div class="balAmount"><span class="balBars"><!--5,10,15,20,18,16,14,20,15,16,12,10--></span><span>8.57</span></div>
                </div>
            ...
            <div id="tab-container" class="tab-container">
                ...
                <div id="alt1">
                    ...
                    <ul class="userList">
                        <li>
                            <a href="#" title="">
                                <img src="images/live/nino1.jpg" alt="" />
                                <span class="contactName">
                                    <strong>Ramón Sigala <span>(7)</span></strong>
                                    <i>Primaria 2A</i>
                                </span>
                        ...
                        <li>
                            <a href="#" title="">
                                <img src="images/live/nino2.jpg" alt="" />
                                <span class="contactName">
                                    <strong>Andrea Ponce <span>(2)</span></strong>
                                    <i>Primaria 6B</i>
                                </span>
                        ...
                        <li>
                            <a href="#" title="">
                                <img src="images/live/nino3.jpg" alt="" />
                                <span class="contactName">
                                    <strong>Lucia Romo</strong>
                                    <i>Kinder 3A</i>
                                </span>

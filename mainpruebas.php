...
<?php
    error_reporting(0);
    require_once('clases/ui/sidebarpruebas.php');
    error_reporting(1);
?>
...
<div id="content">
    <div class="contentTop">
        ...
        <ul class="quickStats">
            <li>
                ...
                <div class="floatR"><strong class="blue">8.5</strong><span>promedio</span></div>
            </li>
            <li>
    ...
    <div class="breadLine">
        ...
        <div class="breadLinks">
            <ul>
                <li><a href="#" title=""><i class="icos-list"></i><span>Listas</span> <strong>(+58)</strong></a></li>
                <li><a href="#" title=""><i class="icos-check"></i><span>Tareas</span> <strong>(+12)</strong></a></li>
                <li class="has">
                    <a title="">
    ...
    <div class="wrapper">
        ...
        <div class="fluid">
            ...
            <div class="widget grid6">
                ...
                <ul class="messagesOne">
                    <li class="by_user">
                        <a href="#" title=""><img src="images/live/nino1.jpg" alt="" /></a>
                        <div class="messageArea">
                            <span class="aro"></span>
                            <div class="infoRow">
                                <span class="name"><strong>Ramón</strong> dice:</span>
                    ...
                    <li class="by_me">
                        <a href="#" title=""><img src="images/live/nino2.jpg" alt="" /></a>
                        <div class="messageArea">
                            <span class="aro"></span>
                            <div class="infoRow">
                                <span class="name"><strong>Andrea</strong> dice:</span>
        ...
        <div class="widget">
        <div class="whead"><h6><?php echo $texts['sec_inventario']; ?></h6><div class="clear"></div></div>

...
require_once('../clases/mysqlcon.php');
    ...
    $elsql = "SELECT tareas.nombre AS qnombre, tareas.descripcion, tareas.fecha, tareas.fechaentrega, grupos.nombre AS qgruponombre, materias.nombre AS qmaterianombre, tareas_status.simpleanswer AS qanswer, tareas_status.answered AS qanswered, tareas_status.doc AS qdoc FROM tareas, grupos, materias, tareas_status WHERE tareas.code = '".$_GET['qcode']."' AND grupos.idGrupos = tareas.idGrupos AND materias.idMaterias = tareas.idMaterias AND tareas_status.code = '".$_GET['qcode']."' AND tareas_status.idAlumno = '".$_SESSION['idUsers']."'";

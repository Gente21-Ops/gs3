...
session_start();
  ...
  */
  ...
  $sql="INSERT INTO profesores_mapeo_materias (idUsers, idMaterias) VALUES ('".mysql_real_escape_string($_REQUEST['maestro'])."', '".mysql_real_escape_string($_REQUEST['materia'])."')";

...
if($_SESSION['qlen'] == "es"){
	...
	"tabletitle" => "Datos de cuenta del padre de familia: ",
	...
	"img_but_browse" => "Cambiar foto del padre de familia",
	"img_advice" => "Haz click en 'Buscar foto'");
} else if($_SESSION['qlen'] == "en"){
	$texts = array(
	"title" => "Account settings for parent ", 
	"tabletitle" => "Account data for parent: ",
	...
	"img_but_browse" => "Browse picture for parent ",

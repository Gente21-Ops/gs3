        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    ...
                    "alertTextDateRange": "* Los dos rangos de fecha son requeridos"
                },
                "dateRange": {
                    "regex": "ninguno",
                    "alertText": "* Inválido ",
                ...
                "dateTimeRange": {
                    "regex": "ninguno",
                    "alertText": "* Inválido ",
                    "alertText2": "Rango de hora y tiempo"
                },
                "minSize": {
                    "regex": "ninguno",
                    "alertText": "* Mínimo ",
				...
				"groupRequired": {
                    "regex": "ninguno",
                    "alertText": "* Debes llenar alguno de los campos a continuación"
                },
                "min": {
                    "regex": "ninguno",
                ...
                "creditCard": {
                    "regex": "ninguno",
                    "alertText": "* Número de tarjeta inválido"
                },
                "phone": {
                ...
                "date": {
                    ...
                    "alertText": "* Fecha inválida, el formato debe ser AAAA-MM-DD"
                },
                "ipv4": {
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Nombre de usuario ya usado",
                ...
                "validate2fields": {
                    "alertText": "* Por favor entre HOLA"
                },
				...
				"dateTimeFormat": {
                    ...
                    "alertText": "* Fecha o formato inválido",
                    "alertText2": "Formato deseado: ",
                    "alertText3": "mm/dd/aaaa hh:mm:ss AM|PM o ", 

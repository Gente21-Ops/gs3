...
include('dict/student_payments.php');
    ...
    <div class="wrapper">
        ...
        <div class="fluid">
            ...
            <div class="grid12">
                <div class="widget">
                    <div class="whead">
                        <h6><?php echo $texts['sec_pagos']; ?></h6><div class="clear"></div>
                    </div>
                    
                    <?php //la clase de la tabla se debe registrar en functions.js ?>
                    <table cellpadding="0" cellspacing="0" width="100%" class="tDefault">
                        <thead>
                            <tr>
                                <td class="sortCol"><?php echo $texts['sec_nombre']; ?></td>
                                <td class="sortCol"><?php echo $texts['sec_descripcion']; ?></td>
                                <td class="sortCol"><?php echo $texts['sec_cantidad']; ?></td>
                                <td class="sortCol"><?php echo $texts['sec_acciones']; ?></td>
                                <td class="sortCol"><?php echo $texts['sec_status']; ?></td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if (isset($_GET['err'])){
                                if ($_GET['err'] == '1'){
                                    echo " &nbsp; ERROR: ".$texts['sec_err1']." <a href='student_payments'>".$texts['sec_err1_vertodos']."</a>";
                                } else if ($_GET['err'] == '2'){
                                    echo " &nbsp; ERROR: ".$texts['sec_err1']." <a href='student_payments'>".$texts['sec_err1_vertodos']."</a>";
                                } else if ($_GET['err'] == '3'){
                                    echo " &nbsp; ERROR: ".$texts['sec_err1']." <a href='student_payments'>".$texts['sec_err2_pagado']."</a>";
                                }
                            } else {
                               include('clases/student/tabla_pagos_nojson.php'); 
                            }
                            ?>
                        </tbody>
                    </table>
